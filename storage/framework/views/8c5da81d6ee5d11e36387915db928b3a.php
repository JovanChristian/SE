...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/MynurzeAfter.css')); ?>">
    <script src="<?php echo e(asset('js/MynurzeAfter.js')); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>MynurzeLogin Page</title>
</head>
<body>
    <!-- header start -->
    <header>
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="<?php echo e(asset('image/Mynurzebanner.jpg')); ?>" alt="">
            <!-- container start -->
                ...
                <div class="content_box">
                    ...
                    <div class="tab_content">
                        <div class="info">
                            ...
                            <p>                              
                                Mynurze Adalah Agency Penyalur Perawat Home Care Yang Melayani Perawatan  Pasien di Rumah Selama 24 Jam. Kami Menghadirkan Layanan Perawat Home  Care Live-In Mulai Dari Perawat Orang Tua, Perawat Orang Sakit, Perawat  Semi Medis Hingga Pasien Medis Atau Pasien Yang Terpasang Alat/ ICU.                               
                            </p>
                        </div>
                        <div class="penghargaan">
                            <h3>Penghargaan</h3>
                            <ol class="penghargaan-list">
                                <li>"Penghargaan Layanan Kesehatan Terbaik" - Indonesia 2018</li>
                                <li>"Layanan Kesehatan Rumah Terbaik di Dunia pada Tahun 2012" - London 2012</li>
                                <li>"Penghargaan Inovasi dalam Pelayanan Medis" - Bekasi 2012</li>
                                <li>"Penghargaan Kontribusi dalam Meningkatkan Kesehatan Masyarakat" - Jakarta 2010</li>
                            </ol>                            
                        </div>
                        <div class="sosmed">
                            <h3>Sosial Media</h3>
                        ...
                        <div class="pengasuh_box">
                            ...
                            <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team19.jpg')); ?>" alt="">
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Yuna adarista, A.MD.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                            ...
                            <!-- detail pengasuh end -->
                                <div class="pengalaman">
                                    ...
                                    <ol class="pengalaman-list">
                                        <li>Praktek RST Dr. Soedjono Barat</li>
                                        <li>Praktek RSUD Hj. Mandayana Tangerang</li>
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team20.jpeg')); ?>" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Yossy Boby, S.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                                                <i class='bx bx-first-aid'></i>
                                                <span>1 tahun</span>
                                ...
                                <div class="pengalaman">
                                    <h3>Pengalaman Kerja dan Magang</h3>
                                    <ol class="pengalaman-list">
                                        <li>Praktek di RS. Insan Kasih</li>
                                        <li>Praktek di RSUD Soegiri Lampung</li>
                                        <li>Praktek di RSJD Bogor</li>
                                        <li>Praktek di Panti Asuhan Tangan Kasih</li>
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team21.jpg')); ?>" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Santi Marinah</h4>
                                        <div class="p_profile">
                                ...
                                <div class="pengalaman">
                                    <h3>Pengalaman Kerja dan Magang</h3>
                                    <ol class="pengalaman-list">
                                        <li>Pengalaman Pelatihan di Nannycare selama 3 bulan</li>
                                        <li>Pengalaman PKL di UPT Krisna Rembulan</li>
                                    </ol>                            
                                </div>
                            </div>
                                <!-- pengasuh 3 end -->
                                 ...
                                 <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team22.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Haekal Mulyadi, S.Kep.</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
                                    ...
                                    <div class="pengalaman">
                                        ...
                                        <ol class="pengalaman-list">
                                            ...
                                            <li>Praktek di PSTW (Panti Jompo) Magelang</li>
                                            <li>Praktek di RSUD Soeprapto Cepu</li>
                                            <li>Praktek di RS. Iban Suryadi</li>
                                            <li>Praktek di RSUD Husada</li>
                                        </ol>                            
                                    </div>
                                </div>
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team23.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Tufik Sitohan</h4>
                                            <div class="p_profile">
                                    ...
                                    <div class="pengalaman">
                                        <h3>Pengalaman Kerja dan Magang</h3>
                                        <ol class="pengalaman-list">
                                            <li>Praktek di RS. Ibu Sina Banjar</li>
                                            <li>Praktek di RSUD Sugi Pontianak</li>
                                            <li>Praktek di RSJD Bandung</li>
                                            <li>Praktek di PSTW (Panti Jompo) Denpasar</li>
                                            <li>Praktek di RSUD Soehasan cepru</li>
                                            <li>Praktek di RS. Iban balyani</li>
                                            <li>Praktek di RSUD Hassanudin</li>
                                        </ol>                            
                                    </div>
                                </div>
                                    <!-- pengasuh 5 end -->
        ...
        <div class="sectionB">
            ...
            <div class="container">
                ...
                <!-- maps start -->
                <div class="maps">
                    <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.4763617892436!2d106.79573967357531!3d-6.200713660740935!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3fa631cc363%3A0x86dce30036ea7e9!2sMyNurz%20Indonesia!5e0!3m2!1sid!2sid!4v1718971691485!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                    
                    <!-- detail maps start -->
                    <div class="detail">
                        <div class="icons">
                            <i class='bx bxs-location-plus' ></i> 
                            <span>Grand Slipi Tower, Jl. Letjen S. Parman No.24 Lt. 5, RT.1/RW.4, Palmerah, Kec. Palmerah, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11480</span>                       
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/MynurzeAfter.blade.php ENDPATH**/ ?>