...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("css/Putrainsan.css")); ?>">
    <script src="<?php echo e(asset("js/Putrainsan.js")); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>Putrainsan Page</title>
</head>
<body>
    <!-- header start -->
    <header>
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="<?php echo e(asset("image/PutrainsanBanner.jpg")); ?>" alt="">
            <!-- container start -->
                ...
                <div class="content_box">
                    ...
                    <div class="tab_content">
                        <div class="info">
                            ...
                            <p>                              
                                Putra Insan Mandiri Adalah Agency Penyalur Perawat Home Care Yang Melayani Perawatan  Pasien di Rumah Selama 24 Jam. Kami Menghadirkan Layanan Perawat Home  Care Live-In Mulai Dari Perawat Orang Tua, Perawat Orang Sakit, Perawat  Semi Medis Hingga Pasien Medis Atau Pasien Yang Terpasang Alat/ ICU.                               
                            </p>
                        </div>
                        <div class="penghargaan">
                            <h3>Penghargaan</h3>
                            <ol class="penghargaan-list">
                                <li>"Penghargaan Layanan Kesehatan Terbaik" - Indonesia 2010</li>
                                <li>"Layanan Kesehatan Rumah Terbaik di Dunia pada Tahun 2007" - London 2007</li>
                                <li>"Penghargaan Inovasi dalam Pelayanan Medis" - Batam 2024</li>
                                <li>"Penghargaan Kontribusi dalam Meningkatkan Kesehatan Masyarakat" - Jakarta 2023</li>
                            </ol>                            
                        </div>
                        <div class="sosmed">
                            <h3>Sosial Media</h3>
                            <div class="data">
                                ...
                                <span>@Putra Insan Mandiri_id</span>
                            </div>
                            <div class="data">
                                <i class='bx bxl-youtube' ></i>
                                <span>PutraInsanMandiri</span>                               
                            </div>
                            <div class="data">
                                <i class='bx bxl-facebook-circle' ></i>
                                <span>Putra Insan Mandiri</span>                               
                            </div>
                            <div class="data">
                                <i class='bx bxl-twitter'></i>
                                <span>@PutraInsanMandiri_id</span>                               
                            </div>
                        </div>
                    </div>
                    <!-- content pengasuh -->
                        ...
                        <div class="pengasuh_box">
                             ...
                             <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset("image/team30.jpg")); ?>" alt="">
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Junedi Arya, A.MD.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset("image/team31.jpg")); ?>" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Ayat Wawanto, S.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                                                <i class='bx bx-first-aid'></i>
                                                <span>1 tahun</span>
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset("image/team32.jpg")); ?>" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Junghyun monaka</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                                                <i class='bx bx-first-aid'></i>
                                                <span>1 tahun</span>
                                ...
                                <div class="pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="images/team34.jpg" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Chani Sidabutar, S.Kep.</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="images/team35.jpg" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Josh Simanjuntak</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset("image/team36.jpg")); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Christian Zong, A.MD.KEP.</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
        ...
        <div class="sectionB">
            ...
            <div class="container">
                ...
                <!-- maps start -->
                <div class="maps">
                    <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.527535297425!2d106.66499467357512!3d-6.193906260678834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f9df7636ef4f%3A0xaa26f31d53f1d300!2sPT.%20Putra%20Mandiri%20Agency!5e0!3m2!1sid!2sid!4v1718975382826!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    <!-- detail maps start -->
                    <div class="detail">
                        <div class="icons">
                            <i class='bx bxs-location-plus' ></i> 
                            <span>Jl. Nurul Yaqin Jl. Perumahan Alam Indah No.mor c72, RT.003/RW.004, Poris Plawad Indah, Kec. Cipondoh, Kota Tangerang, Banten 15141</span>                       
        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="textregister">
                    ...
                    <a id="registerBtn" class="daftar" href="">Daftar Sekarang</a>
                </div>
                <button  class="masuk" type="submit"> <a href="PutrainsanAfter.html">Masuk</a></button>
            </form>
        </div>
    </div>
    ...
    <div id="registerModal" class="modal2">
        <div class="modal2-content">
            ...
            <form>
                ...
                <button class="daftar2" type="submit"><a href="PutrainsanAfter.html">Daftar</a></button>
            </form>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/Putrainsan.blade.php ENDPATH**/ ?>