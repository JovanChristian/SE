...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/InsanMedikaAfter.css')); ?>">
    <script src="<?php echo e(asset('js/InsanMedikaAfter.js')); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>InsanMedikaLogin Page</title>
</head>
<body>
    <!-- header start -->
    <header>
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                ...
                                <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team1.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team2.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team3.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>prilla dahlia</h4>
                                            <div class="p_profile">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team7.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/InsanMedikaAfter.blade.php ENDPATH**/ ?>