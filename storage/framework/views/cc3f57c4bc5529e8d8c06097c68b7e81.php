...
<!-- link icon -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/YayasanLogin.css')); ?>">
</head>
...
<body> 
     ...
     <header>
        <div class="navbar" id="myNav">
            <a class="logo">SaKe</a>
            <a href="<?php echo e(route('homepage')); ?>" class="menu">Beranda</a>
            <a href="<?php echo e(route('yayasanlogin')); ?>" class="active">Yayasan</a>
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <form class="log-in" method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
    ...
    <div id="registerModal" class="modal2">
        <div class="modal2-content">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="log-in">
                <?php echo csrf_field(); ?>
...
<section class="yayasan-menu" id="yayasan-menu">
    ...
    <div class="box-container1">
        ...
        <div class="box1" data-name ="Capten Care" data-location="Jakarta Selatan"><a href="#captencare">
            <img src="<?php echo e(asset("/image/Capten-Care-Logo-Low-px.jpg")); ?>" alt="Capten Care">
            <h1>Capten Care</h1>
        ...
        <div class="box1" data-name ="CaregiverID" data-location="Depok"><a href="#caregive">
            <img src="<?php echo e(asset("/image/images.jpg")); ?>" alt="CaregiverID">
            <h1>CaregiverID</h1>
            <div class="buttons-container">
                <button>Pengasuh Lansia</button>
            </div>
        ...
        <div class="box1" data-name ="Insan Medika"  data-location="Tangerang"><a href="InsanMedika.html">
            <img src="<?php echo e(asset("/image/insanmedika.jpg")); ?>" alt="">
            <h1>Insan Medika</h1>
            <div class="buttons-container">
                <button>Pengasuh Lansia</button>
        ...
        <div class="box1" data-name ="Nanny Care" data-location="Bogor"><a href="#nanny">
            <img src="<?php echo e(asset("/image/new-logo.png")); ?>" alt="">
            <h1>Nanny Care</h1>
        ...
        <div class="box1" data-name ="My Nurz" data-location="Jakarta Barat"><a href="#nurz">
            <img src="<?php echo e(asset("/image/photo1654222896.jpg")); ?>" alt="">
            <h1>My Nurz</h1>
            <div class="buttons-container">
                <button>Pengasuh Lansia</button>
                <!-- <button>Pengasuh Anak</button> -->
        ...
        <div class="box1" data-name ="Putra Insan Mandiri" data-location="Bekasi"><a href="#putrainsan">
            <img src="<?php echo e(asset("/image/yayasan4.png")); ?>" alt="">
...
<script src="<?php echo e(asset('js/YayasanLogin.js')); ?>"></script>
</body>


</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/YayasanLogin.blade.php ENDPATH**/ ?>