...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/CaregiverID.css')); ?>">
    <script src="<?php echo e(asset('js/CaregiverID.js')); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>Caregiver Page</title>
</head>
<body>
    <!-- header start -->
    <header>
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="<?php echo e(asset('image/CaregiverIDbanner.jpg')); ?>" alt="">
            <!-- container start -->
                ...
                <div class="content_box">
                    ...
                    <div class="tab_content">
                        <div class="info">
                            ...
                            <p>                              
                                CaregiverID Adalah Agency Penyalur Perawat Home Care Yang Melayani Perawatan  Pasien di Rumah Selama 24 Jam. Kami Menghadirkan Layanan Perawat Home  Care Live-In Mulai Dari Perawat Orang Tua, Perawat Orang Sakit, Perawat  Semi Medis Hingga Pasien Medis Atau Pasien Yang Terpasang Alat/ ICU.                               
                            </p>
                        </div>
                        <div class="penghargaan">
                            <h3>Penghargaan</h3>
                            <ol class="penghargaan-list">
                                <li>"Penghargaan Layanan Kesehatan Terbaik" - Indonesia 2012</li>
                                <li>"Layanan Kesehatan Rumah Terbaik di Dunia pada Tahun 2014" - London 2014</li>
                                <li>"Penghargaan Inovasi dalam Pelayanan Medis" - Bekasi 2019</li>
                                <li>"Penghargaan Kontribusi dalam Meningkatkan Kesehatan Masyarakat" - Jakarta 2013</li>
                            </ol>                            
                        </div>
                        <div class="sosmed">
                            <h3>Sosial Media</h3>
                            <div class="data">
                                ...
                                <span>@CaregiverID_id</span>
                            </div>
                            <div class="data">
                                <i class='bx bxl-youtube' ></i>
                                <span>CaregiverID</span>                               
                            </div>
                            <div class="data">
                        ...
                        <div class="pengasuh_box">
                            ...
                            <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team13.png')); ?>" alt="">
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Renjani Putra, A.MD.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team14.jpeg')); ?>" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Windara Immanuel, S.KEP.</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                                                <i class='bx bx-first-aid'></i>
                                                <span>1 tahun</span>
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset('image/team15.jpg')); ?>" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Jaeman Handoko</h4>
                                        <div class="p_profile">
                                            <div class="p_data">
                                                <i class='bx bx-first-aid'></i>
                                                <span>1 tahun</span>
                                ...
                                <!-- pengasuh 3 end -->
                                 ...
                                 <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team16.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Tita Rayani</h4>
                                            <div class="p_profile">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team17.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Anika Taranika, A.MD.KEP.</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset('image/team18.jpg')); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Gillia Bosuari, S.Kep.</h4>
                                            <div class="p_profile">
                                                <div class="p_data">
                                                    <i class='bx bx-first-aid'></i>
                                                    <span>1 tahun</span>
        ...
        <div class="sectionB">
            ...
            <div class="container">
                ...
                <!-- maps start -->
                <div class="maps">
                    <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.63585003958!2d106.70947627357488!3d-6.179472960547445!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f90b6587769d%3A0xfac88254fac1006b!2sCaregiver%20ID%20%E2%80%A2%20Perawat%20Home%20Care%20%26%20Caregiver!5e0!3m2!1sid!2sid!4v1718969681371!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    <!-- detail maps start -->
                    <div class="detail">
                        <div class="icons">
                            <i class='bx bxs-location-plus' ></i> 
                            <span>Rukan Sentra Niaga, Jl. Green Lake City Boulevard No. M 19, Duri Kosambi, Kecamatan Cengkareng, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11750</span>                       
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/CaregiverID.blade.php ENDPATH**/ ?>