...
<body>
    <header>
        <div class="navbar" id="myNav">
            ...
            <a href="<?php echo e(route('yayasanlogin')); ?>" class="menu">Yayasan</a>
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="textregister">
                    ...
                    <a id="registerBtn" class="daftar" href="<?php echo e(route('register')); ?>">Daftar Sekarang</a>
                </div>
    ...
    <div class="content">
            ...
            <section class="swipecontent">
                <div class="swiper mySwiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="<?php echo e(asset("image/Rectangle 3.png")); ?>" alt=""></div>
                        <div class="swiper-slide"><img src="<?php echo e(asset("image/orangsakit.png")); ?>" alt=""></div>
                        <div class="swiper-slide"><img src="<?php echo e(asset("image/semimedis.png")); ?>" alt=""></div>
                        <div class="swiper-slide"><img src="<?php echo e(asset("image/lansiaindex.png")); ?>" alt=""></div>
                    </div>
        ...
        <div class="yayasan">
            <div class="yayasantext">
                ...
                <img src="<?php echo e(asset("image/nanny1.png")); ?>" alt="">
            </div>
            <div class="yayasancontent">
                <div class="ycontent1">
                    <img id="logo1" src="<?php echo e(asset("image/insanmedika.jpg")); ?>" alt="">
                    <div class="yc1text">
                        <div class="yc1text1">Insan Medika</div>
                        <div class="yc1text2"> Pengasuh Lansia </div>
                        <div class="yc1info">
                            <div class="rating1">
                                <img src="<?php echo e(asset("image/Vector.png")); ?>" alt="">
                                <a>4.7</a>
                            </div>
                            <div class="lokasi1">
                                <img src="<?php echo e(asset("image/vectorrr.png")); ?>" alt="">
                                <a>Jakarta Selatan</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ycontent1">
                    <img id="logo2" src="<?php echo e(asset("image/Capten-Care-Logo-Low-px.jpg")); ?>" alt="">
                    <div class="yc1text">
                ...
                <div class="ycontent1">
                    <img id="logo3" src="<?php echo e(asset("image/new-logo.png")); ?>" alt="">
                    <div class="yc1text">
            ...
            <div class="yayasanmelihat">
                <form action="<?php echo e(route('yayasanlogin')); ?>">
        ...
        <div class="tentangkami">
            ...
            <div class="tentangkamicontent">
                <div class="content1">
                    <img src="<?php echo e(asset("image/contract_icon-removebg-preview.png")); ?>" alt="">
                    <div class="textcontent1">Memiliki sistem kontrak yang menjamin kesepakatan sah antara Yayasan dan
                        Klien</div>
                </div>
                <div class="content1">
                    <img src="<?php echo e(asset("image/trophy-removebg-preview.png")); ?>" alt="">
                    <div class="textcontent1">Kerjasama dengan Yayasan-Yayasan Terkemuka di Indonesia yang Diakui dan
                        Terpercaya</div>
                </div>
                <div class="content1">
                    <img src="<?php echo e(asset("image/document-removebg-preview.png")); ?>" alt="">
        ...
        <div class="footer">
            ...
            <div class="explore"><a>Explore</a>
                <div class="footerLink">
                    <a class="linkcontent" href="<?php echo e(route('homepage')); ?>">Beranda</a>
                    <a class="linkcontent" href="<?php echo e(route('yayasanlogin')); ?>">Yayasan</a>
...
</body><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/homepage.blade.php ENDPATH**/ ?>