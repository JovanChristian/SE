...
<!-- link icon -->
    ...
    <!-- link ke css  -->
    <link rel="stylesheet" href="<?php echo e(asset('css/yayasan.css')); ?>">
</head>
     ...
     <header>
        ...
        <div class="navbar" id="myNav">
            ...
            <div class = "profile">
                ...
                <a href="Prof.html">
                    <img src="<?php echo e(asset("images/icon.jpg")); ?>" class="account">
                </a>
            </div>
...
<section class="yayasan-menu" id="yayasan-menu">
    ...
    <div class="box-container1">
        ...
        <div class="box1" data-name ="CaregiverID" data-location="Depok"><a href="#caregive">
            <img src="<?php echo e(asset("/image/images.jpg")); ?>" alt="">
            <h1>CaregiverID</h1>
            <div class="buttons-container">
                <button>Pengasuh Lansia</button>
            </div>
...
<footer>
    ...
    <script src="<?php echo e(asset("Yayasan.js")); ?>"></script>
</body>


</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/Yayasan.blade.php ENDPATH**/ ?>