...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/CaptencareAfter.css')); ?>">
    <script src="<?php echo e(asset('js/CaptencareAfter.js')); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>CaptenCareLogin Page</title>
</head>
<body>
    <!-- header start -->
    <header>
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="<?php echo e(asset("image/CaptencareBanner.png")); ?>" alt="">
            <!-- container start -->
                    ...
                    <div class="tab_content">
                           ...
                           <div class="pengasuh">
                            ...
                            <div class="pengasuh_detail">
                                <div class="pengasuh_img">
                                    <img src="<?php echo e(asset("image/team8.jpeg")); ?>" alt="">
                                </div>
                        ...
                        <!-- pengasuh 1 end -->
                         ...
                         <div class="pengasuh">
                            <div class="pengasuh_detail">
                                <div class="pengasuh_img">
                                    <img src="<?php echo e(asset("image/team9.jpg")); ?>" alt="">                                  
                                </div>
                                <div class="info_pengasuh">
                          ...
                          <!-- pengasuh 2 end -->
                           ...
                           <div class="pengasuh">
                            <div class="pengasuh_detail">
                                <div class="pengasuh_img">
                                    <img src="<?php echo e(asset("image/team10.jpg")); ?>" alt="">                                   
                                </div>
                                <div class="info_pengasuh">
                            ...
                            <!-- pengasuh 3 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset("image/team11.jpg")); ?>" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                              ...
                              <!-- pengasuh 4 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="<?php echo e(asset("image/team12.jpeg")); ?>" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
      ...
      <div class="footer">
        ...
        <div class="copyright">
            <img class="imgcopyr" src="<?php echo e(asset("images/Line 2.png")); ?>" alt="">
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/CaptaincareAfter.blade.php ENDPATH**/ ?>