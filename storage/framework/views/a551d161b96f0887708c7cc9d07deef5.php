...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("css/PutrainsanAfter.css")); ?>">
    <script src="<?php echo e(asset("js/PutrainsanAfter.js")); ?>"></script> 
    <script src="https://unpkg.com/feather-icons"></script>
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <title>PutrainsanLogin Page</title>
</head>
<body>
    <!-- header start -->
    <header>
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                ...
                                <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset("image/team33.jpg")); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset("image/team34.jpg")); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="<?php echo e(asset("image/team35.jpg")); ?>" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
...
</html><?php /**PATH C:\Users\Jovan\Downloads\hendriganteng\hendriganteng\resources\views/PutrainsanAfter.blade.php ENDPATH**/ ?>