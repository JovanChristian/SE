...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/InsanMedika.css')}}">
    <script src="{{asset('js/InsanMedika.js')}}"></script> 
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="{{asset('image/insan medika.jpeg')}}" alt="">
            <!-- container start -->
                        ...
                        <div class="pengasuh_box">
                            ...
                            <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team4.jpg')}}" alt="">
                                    </div>
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team5.jpeg')}}" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team6.jpeg')}}" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                ...
                                <!-- pengasuh 3 end -->
                                 ...
                                 <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team1.jpeg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team3.jpeg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Prilla Dahlia</h4>
                                            <div class="p_profile">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team7.jpeg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
