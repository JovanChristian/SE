...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/MynurzeAfter.css')}}">
    <script src="{{asset('js/MynurzeAfter.js')}}"></script> 
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="{{asset('image/Mynurzebanner.jpg')}}" alt="">
            <!-- container start -->
                        ...
                        <div class="pengasuh_box">
                            ...
                            <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team19.jpg')}}" alt="">
                                    </div>
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team20.jpeg')}}" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team21.jpg')}}" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                        <h4>Santi Marinah</h4>
                                        <div class="p_profile">
                                ...
                                <!-- pengasuh 3 end -->
                                 ...
                                 <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team22.jpg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team23.jpg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Tufik Sitohan</h4>
                                            <div class="p_profile">
