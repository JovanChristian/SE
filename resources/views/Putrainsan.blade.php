...
<head>
    ...
    <link rel="stylesheet" href="{{asset("css/Putrainsan.css")}}">
    <script src="{{asset("js/Putrainsan.js")}}"></script> 
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="{{asset("image/PutrainsanBanner.jpg")}}" alt="">
            <!-- container start -->
                        ...
                        <div class="pengasuh_box">
                             ...
                             <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset("image/team30.jpg")}}" alt="">
                                    </div>
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset("image/team31.jpg")}}" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset("image/team32.jpg")}}" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                ...
                                <div class="pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset("image/team36.jpg")}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
