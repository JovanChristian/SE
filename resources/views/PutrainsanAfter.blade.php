...
<head>
    ...
    <link rel="stylesheet" href="{{asset("css/PutrainsanAfter.css")}}">
    <script src="{{asset("js/PutrainsanAfter.js")}}"></script> 
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                ...
                                <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset("image/team33.jpg")}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset("image/team34.jpg")}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset("image/team35.jpg")}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
