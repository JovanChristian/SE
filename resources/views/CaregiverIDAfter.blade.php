...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/CaregiverIDAfter.css')}}">
    <script src="{{asset('js/CaregievrIDAfter.js')}}"></script> 
    ...
    <div class="text">
      ...
      <!-- content start -->
       <div class="wrapper">
        <div class="sectionA">
            <!-- image -->
            <img src="{{asset('image/CaregiverIDbanner.jpg')}}" alt="">
            <!-- container start -->
                        ...
                        <div class="pengasuh_box">
                            ...
                            <div class="pengasuh">
                                ...
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team13.png')}}" alt="">
                                    </div>
                            ...
                            <!-- pengasuh 1 end -->
                             ...
                             <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team14.jpeg')}}" alt="">                                  
                                    </div>
                                    <div class="info_pengasuh">
                              ...
                              <!-- pengasuh 2 end -->
                               ...
                               <div class="pengasuh">
                                <div class="pengasuh_detail">
                                    <div class="pengasuh_img">
                                        <img src="{{asset('image/team15.jpg')}}" alt="">                                   
                                    </div>
                                    <div class="info_pengasuh">
                                ...
                                <!-- pengasuh 3 end -->
                                 ...
                                 <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team16.jpg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                            <h4>Tita Rayani</h4>
                                            <div class="p_profile">
                                  ...
                                  <!-- pengasuh 4 end -->
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team17.jpg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
                                   ...
                                   <div class="pengasuh">
                                    <div class="pengasuh_detail">
                                        <div class="pengasuh_img">
                                            <img src="{{asset('image/team18.jpg')}}" alt="">                                   
                                        </div>
                                        <div class="info_pengasuh">
